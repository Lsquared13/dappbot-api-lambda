...
exports.handler = function (event) { return __awaiter(_this, void 0, void 0, function () {
    var method, body, cognitoUsername, callerEmail, responseOpts, responsePromise, responseBody, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                method = event.pathParameters.proxy;
                if (event.body) {
                    body = JSON.parse(event.body);
                }
                return [2 /*return*/, successResponse({ body: body })];
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, responsePromise];
            case 2:
                responseBody = _a.sent();
                return [2 /*return*/, successResponse(responseBody, responseOpts)];
            case 3:
                err_1 = _a.sent();
                return [2 /*return*/, errorResponse(err_1, responseOpts)];
